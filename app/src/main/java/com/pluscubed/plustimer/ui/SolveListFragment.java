...
public class SolveListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListView.setOnItemClickListener((parent, view, position, id) ->
                        SolveDialogUtils.createSolveDialog(
                                getActivity(), false, mPuzzleTypeId, mSessionId,
    ...
    public class SolveListAdapter extends ArrayAdapter<Solve> {
        ...
        public SolveListAdapter() {
            super(getActivity(), 0, new ArrayList<>());
            ...
            /*mSession.getSolves()
                    ...
                    .subscribe(solves -> {
                        mBestAndWorstSolves = new Solve[]{};
                        mBestAndWorstSolves[0]=Utils.getBestSolveOfList(solves);
                        mBestAndWorstSolves[1]=(Utils.getWorstSolveOfList(solves));
                        mSignEnabled = PrefUtils.isSignEnabled(getActivity());
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            for (Solve a : mBestAndWorstSolves) {
                if (a == s) {
                    String text = "(" + s.getDescriptiveTimeString(mMillisecondsEnabled) + ")";
                    time.setText(text);
                }
            }
